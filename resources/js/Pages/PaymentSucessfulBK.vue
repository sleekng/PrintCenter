<template>
    ...
    <div class="bg-white max-w-[500px] text-center border border-gray-300 rounded-lg p-5">
        ...
        <div class="mb-2.5">
            <Link :href="route('home')"><img src="/storage/img/logo-main.png" alt="Print Centre" class="h-20 mx-auto"></Link>
        </div>
        ...
        <div class="bg-gray-100 p-10 rounded-lg text-left">
            ...
            <div class="pt-4">
                ...
                Kindly come to the pick up center with the a screenshot or print out of the above reciept to claim item(s).
            </span>
