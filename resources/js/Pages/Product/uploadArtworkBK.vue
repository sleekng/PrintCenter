...
<section class="py-12 sm:py-16 ">
    <div class="container mx-auto px-24">
        ...
        <div class="pt-20">
            <div>
                <h2 v-for="productDetail in product" :key="productDetail" class="font-bold text-4xl">
            ...
            <div v-if="$page.props.flash.error" class="bg-red-50 border-s-4 border-red-500 p-4 dark:bg-red-800/30" role="alert">
                <div class="flex">
            ...
            <div class="flex items-center space-x-8 mt-5 rounded-md p-4 shadow-lg">
                <span class="font-bold">Do you have a Design?</span>
                <div class="flex space-x-4 mt-4">
                    <primary-button @click="design('Yes')" :class="
                                    uploadDesign
                                        ? 'bg-primary text-white'
                                        : 'border '
                                " class="px-16 py-4 rounded-md">Yes</primary-button>
                    <primary-button :disabled="form.hireDesigner" :class="
                                    requestDesign || form.hireDesigner
                                        ? 'bg-primary text-white'
                                        : 'border '
                                " @click="design('No')" class="px-16 py-4 rounded-md">No</primary-button>
                </div>
            </div>

            <div class="mt-10 flex space-x-4 justify-between">
                <div class="w-8/12">
                    <div v-if="uploadDesign" class="border rounded-md shadow-lg flex justify-center relative text-center space-y-4 flex-col mt-8 p-10 w-8/12 animate-fade-up animate-duration-[400ms]">
                    ...
                    <div v-if="requestDesign" @click="hire" class="border rounded-md shadow-lg flex justify-center text-center space-y-4 flex-col mt-8 p-10 w-8/12 animate-fade-up animate-duration-[400ms]">
                        <div>
                    ...
                    <div v-if="form.hireDesigner">
                        ...
                        <div>
                            <div>
                                <div class="border rounded-md shadow-lg flex justify-center relative text-center space-y-4 flex-col mt-8 p-4 w-8/12 animate-fade-up animate-duration-[400ms]">
